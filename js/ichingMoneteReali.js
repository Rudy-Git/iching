const ideogrammi = {
    ...
    "788888": "24 Il Ritorno - La Svolta",
    ...
    "877888": "46 Ascendere",
    "878778": "47 L'Assillo - L'Eusarimento",
    "877878": "48 Il Pozzo",
...
function lanciaMoneta() {
  ...
  moneta1 = document.getElementById("monetaReale1").value;
  ...
  moneta2 = document.getElementById("monetaReale2").value;
  ...
  moneta3 = document.getElementById("monetaReale3").value;
...
function scriviLinea6() {
  ...
  document.getElementById("monetaReale1").style.display = "none";
  document.getElementById("monetaReale2").style.display = "none";
  document.getElementById("monetaReale3").style.display = "none";  
